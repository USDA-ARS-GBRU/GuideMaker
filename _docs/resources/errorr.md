...
`[guidemaker.cli](cli.html "guidemaker.cli")`
...
`[guidemaker.core](core.html "guidemaker.core")`

Core classes and functions for GuideMaker.

`[guidemaker.data](data/index.html "guidemaker.data")`

`[guidemaker.definitions](definitions.html "guidemaker.definitions")`
