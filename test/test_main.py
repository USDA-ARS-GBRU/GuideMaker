"""test_core.py: the pytest suite for guidefinder.core
"""
import sys
import os
import pytest
...
guidefinder.core.get_fastas(gnbank, tempdir)

pamobj = guidefinder.core.Pam(pamseq, "3prime")

target_list = pamobj.find_targets(pamobj, strand, targetlength)
