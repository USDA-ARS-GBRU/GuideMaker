...
def main(args=None):
    ...
    try:
        ...
        pamtargets_pa = pamobj.find_targets(seq_record_iter=seq_record_iter, strand="both", target_len=args.guidelength)
        ...
        pamtargets = [x for x in pamtargets if x.targetid in mapped_fasta_header]
